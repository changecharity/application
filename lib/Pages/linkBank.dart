...
class _LinkBankState extends State<LinkBank> with TickerProviderStateMixin {
      ...
      child: Container(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Theme
                .of(context)
                .brightness == Brightness.light ? Colors.grey[100] : Colors
                .grey[900],
            boxShadow: [BoxShadow(
                color: MediaQuery
                    .of(context)
  ...
  Widget _skipText() {
    return Container(
      margin: EdgeInsets.only(top: 0, bottom: MediaQuery
          .of(context)
          .size
          .height < 650 ? 20 : 30, left: 30, right: 30),
      alignment: Alignment.bottomCenter,
      child: GestureDetector(
        onTap: () {
          _chooseLater();
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: MediaQuery
            .of(context)
            .platformBrightness == Brightness.light ? Colors.grey[50] : Colors
            .grey[850],
        title: Text(
          "Step Two",
          style: TextStyle(
  ...
  Future<void> _getToken() async {
    ...
    var response = await http.post(
        "${cfg.getString("host")}/users/createlinktoken", body: content);
  ...
  _addAccount() async {
    ...
    var response = await http.post(
        "${cfg.getString("host")}/users/addcard", body: content);
