...
class _BankAccountDialogState extends State<BankAccountsDialog>
          ...
          itemBuilder: (context, idx) {
            if (idx < userBank.getCards.length + 1) {
              ...
              return _bankCard(
                ...
                idx == 0
                    ? userBank.getMask
                    : userBank.getCards[idx - 1]["mask"],
                idx == 0
                    ? userBank.getBankName
                    : userBank.getCards[idx - 1]["bank_name"],
                idx == 0 ? false : false,
              );
            }
            return Container(
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (BuildContext context) => LinkBank()));
                },
